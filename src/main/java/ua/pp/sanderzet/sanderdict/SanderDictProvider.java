...
public class SanderDictProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "ua.pp.sanderzet.sanderdict.SanderDictProvider";
    static final String SCHEME = "content://";
    static final Uri CONTENT_URI = Uri.parse(SCHEME+AUTHORITY+"/dict");
    DBSanderDict mDict;
    ...
    static final String CONTENT_DIR_TYPE = "vnd.android.cursor.dir/vnd."
            + AUTHORITY;
